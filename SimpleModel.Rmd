...
#add the genus names
conjugation.dataD$LABgenus <- conjugation.dataD$VL_type;
...
conjugation.dataT$LABgenus <- conjugation.dataT$VL_type;
...
growth.data$LABgenus <- growth.data$VL_type;
growth.data[growth.data$Experiment== "Sup_1", ]$LABgenus <- "Pediococcus"
growth.data[growth.data$Experiment== "Sup_2", ]$LABgenus <- "Pediococcus"
growth.data[growth.data$Experiment== "Sup_3", ]$LABgenus <- "Enterococcus"
growth.data[growth.data$Experiment== "Sup_4", ]$LABgenus <- "Lactobacillus"
growth.data[growth.data$Experiment== "Sup_5", ]$LABgenus <- "Pediococcus"
growth.data[growth.data$Experiment== "Sup_6", ]$LABgenus <- "Pediococcus and Enterococcus"
